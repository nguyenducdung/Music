...
public class NotificationGenerator {
    public static final String NOTIFY_PREVIOUS = "rikkeisoft.nguyenducdung.com.music.previous";
    public static final String NOTIFY_DELETE = "rikkeisoft.nguyenducdung.com.music.delete";
    public static final String NOTIFY_PAUSE = "rikkeisoft.nguyenducdung.com.music.pause";
    public static final String NOTIFY_PLAY = "rikkeisoft.nguyenducdung.com.music.play";
    public static final String NOTIFY_NEXT = "rikkeisoft.nguyenducdung.com.music.next";
